...
func BenchmarkExtract(b *testing.B) {
	...
	b.ReportAllocs()
	for b.Loop() {
		if _, err := extract("https://example.test/", source, false); err != nil {
			b.Fatal(err)
		}
	}
}
...
func TestExtractReferences(t *testing.T) {
	...
	got, err := extract("https://example.test/pages/index.html", source, false)
...
func TestExtractOriginAndInlineTypes(t *testing.T) {
	...
	got, err := extract("https://example.test/", source, false)
